...
class AdminCustomerTypeController extends AbstractController
{
    ...
    public function index(EntityManagerInterface $manager)
    {
        ...
        return $this->render('CustomerType/index.html.twig', [
          'current' => 'accounting',
    ...
    public function add(Request $request, EntityManagerInterface $manager)
    {
        ...
        return $this->render('CustomerType/customertype-add.html.twig', [
          'current' => 'accounting',
    ...
    public function edit(Request $request, EntityManagerInterface $manager, CustomerType $customertype)
    {
      ...
      return $this->render('CustomerType/customertype-edit.html.twig', [
        'current'  => 'accounting',
