 ...
 */
final class Version20200526085502 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE returned_product (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, created_by_id INT NOT NULL, updated_by_id INT DEFAULT NULL, commande_id INT NOT NULL, deleted_by_id INT DEFAULT NULL, quantity INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, is_deleted TINYINT(1) NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_AF6E52FEC76F1F52 (deleted_by_id), INDEX IDX_AF6E52FE4584665A (product_id), INDEX IDX_AF6E52FE896DBBDE (updated_by_id), INDEX IDX_AF6E52FEB03A8386 (created_by_id), INDEX IDX_AF6E52FE82EA2E54 (commande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
