...
/**
 * @ORM\Entity(repositoryClass="App\Repository\ProviderEcheanceRepository")
 */
class ProviderEcheance
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\ProviderCommande", inversedBy="echeances")
